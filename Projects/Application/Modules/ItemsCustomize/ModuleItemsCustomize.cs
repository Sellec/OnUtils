...
#pragma warning disable CS1591 // todo внести комментарии.
    ...
    public class ModuleItemsCustomize<TAppCoreSelfReference> : ModuleCore<TAppCoreSelfReference, ModuleItemsCustomize<TAppCoreSelfReference>>, IUnitOfWorkAccessor<Context>, ICritical
        where TAppCoreSelfReference : ApplicationCore<TAppCoreSelfReference>
    {
        public class CacheCollection : IReadOnlyDictionary<SchemeItem, DefaultScheme>
        {
            private ModuleItemsCustomize<TAppCoreSelfReference> _module = null;
            ...
            internal CacheCollection(ModuleItemsCustomize<TAppCoreSelfReference> module)
            {
        ...
        internal static ModuleItemsCustomize<TAppCoreSelfReference> _moduleLink = null;
