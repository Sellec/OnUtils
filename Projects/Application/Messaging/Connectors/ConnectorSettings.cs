namespace OnUtils.Application.Messaging.Connectors
{
    ...
    {
        /// <summary>
        /// Полное имя типа коннектора. Используется в <see cref="MessagingManager{TAppCoreSelfReference}.GetConnectorsByMessageType{TMessage}"/> для поиска настроек коннекторов.
        /// </summary>
