...
namespace OnUtils.Data.EntityFramework.Internal
{
    ...
    class QueryInternal : IQuery, IOrderedQueryable
    {
        ...
        public IQueryProvider Provider
        {
            get
            {
                if (_provider == null)
                {
                    if (_query.Provider is DB.DbQueryProvider provider) _provider = provider;
    ...
    class QueryInternal<TEntity> : QueryInternal, IQuery<TEntity>, IOrderedQueryable<TEntity> where TEntity : class
    {
        ...
        {
            return new QueryInternal<TEntity>(EntityFrameworkQueryableExtensions.AsNoTracking<TEntity>(DBQuery) as DbQuery<TEntity>, Repository);
        }
        ...
        {
            return new QueryInternal<TEntity>(EntityFrameworkQueryableExtensions.Include(DBQuery, path), Repository);
        }
        ...
        {
            get => _query as IQueryable<TEntity>;
        }
    }
}
